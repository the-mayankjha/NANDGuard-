def generate_recommendations(metrics, health_results):
    ...
    if score < 30 or risk == "Critical":
        recs.append("⚠️ CRITICAL: Immediate backup recommended. Device showing signs of imminent failure.")
    ...
    if metrics.get('Temperature', 0) > 60:
        recs.append("🌡️ High Temperature: Improve airflow or reduce workload to prevent NAND throttling.")
